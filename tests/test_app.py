...
def test_signup_accepts_activity_name_with_spaces():
    # Arrange
...
def test_duplicate_signup_returns_bad_request_without_adding_duplicate():
    # Arrange
    activity_name = "Chess Club"
...
def test_unregistering_absent_participant_returns_not_found():
    # Arrange
    activity_name = "Chess Club"
